...
- feat(js): Offer a `dataCollection` setup step on SDK v11 that writes a PII-reducing preset into `Sentry.init` ([#TODO](https://github.com/getsentry/sentry-wizard/pull/TODO))
