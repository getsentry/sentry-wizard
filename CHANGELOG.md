...
- feat(js)!: Install SDK version `^11` in the angular, cloudflare, nextjs, nuxt, react-router, remix and sveltekit wizards ([#1343](https://github.com/getsentry/sentry-wizard/pull/1343))
