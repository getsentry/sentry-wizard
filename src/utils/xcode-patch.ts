...
export function applyXcodePatching(): void {
  pbxProject.prototype.generateUuid = function(this: { allUuids: () => string[] }): string {
    ...
    const random = Math.floor(Math.random() * 0xFFFFFF).toString(16).padStart(12, '0').toUpperCase();
