...
export const getManualClientEntryContent = (
  ...
  // When using instrumentation API with tracing, we store the integration in a variable
...
${plus(`// Create the tracing integration with useInstrumentationAPI enabled
