...
export async function runWizardOnNuxtProject(
  projectDir: string,
): Promise<void> {
...
export function testNuxtProjectSetup(projectDir: string) {
  const integration = Integration.nuxt;
...
export function testNuxtProjectConfigs(projectDir: string) {
...
export function testNuxtProjectBuildsAndRuns(projectDir: string) {
